...
TEST_SVGWRITER_OBJ_FILES	= $(TEST_SVGWRITER_OBJ) $(TEST_SVGWRITER_TEST_OBJ)
...
all: directories run_svgtest run_srctest run_sinktest run_xmltest run_svgwritertest gen_html
...
$(TEST_SVGWRITER_TARGET): $(LIB_DIR)/libsvg.a $(TEST_SVGWRITER_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(LIB_DIR)/libsvg.a $(TEST_SVGWRITER_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_SVGWRITER_TARGET)

$(TEST_XML_TARGET): $(TEST_XML_OBJ_FILES) $(TEST_STRSRC_OBJ)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_XML_OBJ_FILES) $(TEST_STRSRC_OBJ) $(TEST_LDFLAGS) -o $(TEST_XML_TARGET)
